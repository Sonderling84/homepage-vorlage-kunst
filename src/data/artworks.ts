...
export const ARTWORKS_DATA: Artwork[] = [
  ...
  },
  {
    ...
    video: "/artworks/A7A8971C-D2A8-4313-896A-5801156E19E8.MP4",
    description: "Großformatige Anatomiezeichnung aus der Galerie 'Skizzen A3' mit animierter Detailbetrachtung.",
    certificate: true,
  ...
  },
  {
    ...
    image: "/artworks/gold_leaf_canvas_1784989991003.png",
    video: "/artworks/bacb2ddf-9712-429e-8eef-2eee6a99d941.mp4",
    description: "Aus der Werkschau 'Lebenskunst'. Hommage an Ruhe und Achtsamkeit mit fließenden Lichtreflexen.",
    certificate: true,
  ...
  },
  {
    ...
    video: "/artworks/4c4009f8-96d7-4109-9d7a-6d8d7cbefced.mp4",
    description: "Zeitgenössisches abstraktes Werk mit integrierter Motion-Animation.",
    certificate: true,
